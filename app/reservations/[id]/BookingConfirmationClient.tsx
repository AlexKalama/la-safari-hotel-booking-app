...
export default function BookingConfirmationClient({ roomId }: { roomId: string }) {
  ...
  const [isReserving, setIsReserving] = useState(false); // New state for Reserve Now button
  ...
  const navigateToStep = (newStep: number) => {
    if (newStep === 2 && step === 1) {
      setIsReserving(true);
      // Simulate a short loading state before navigating to the next step
      setTimeout(() => {
        setStep(newStep);
         ...
         <div className="md:col-span-1">
           <div className="bg-white p-6 rounded-lg border sticky top-24">
             ...
             <Button 
               ...
               disabled={!checkInDate || !checkOutDate || isReserving}
             >
               {isReserving ? (
                 <>
               ...
               <div className="flex justify-between items-center">
                 ...
                 {!form.getValues("packageId") && (
                   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 text-yellow-600">
                     <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM12.96 10.61A6 6 0 0012 4c-2.33 0-4.33 1.77-4.33 4s1.67 4 4.33 4 4.33-1.77 4.33-4A6 6 0 0012.96 10.61z" clipRule="evenodd" />
                   </svg>
                 )}
               </div>
         ...
         <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg mb-8">
           <div className="flex items-center text-yellow-800">
             <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
               <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zM12.96 10.61A6 6 0 0012 4c-2.33 0-4.33 1.77-4.33 4s1.67 4 4.33 4 4.33-1.77 4.33-4A6 6 0 0012.96 10.61z" clipRule="evenodd" />
             </svg>
